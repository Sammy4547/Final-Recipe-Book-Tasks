...
export default function Navbar() {
  return (
    <header className="bg-gray-900 border-b-2 border-amber-300 dark:bg-gray-100 shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
        ...
        <nav className=" md:flex gap-8 items-center text-sm font-medium text-blue-400">
          ...
          <Link className="font-bold  hover:text-blue-600" to="/addrecipes">
            Add new Recipes
          </Link>
          <ThemeToggle/>
        </nav>
